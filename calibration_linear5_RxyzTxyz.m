...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
function calib_data = calibration_linear5_RxyzTxyz(calib_data)
...
if(~calib_data.linearflag)
    ...
    fprintf(1,'\n(Using linear method).');
    fprintf(1,'\nInitial image center: (%3.2f,%3.2f)',calib_data.ocam_model.xc,calib_data.ocam_model.yc);
...
%   disp('-Using 3D points on Magna intrinsic box-');
    disp('-Using 3D points on Magna final functional tester-');
...
if (calib_data.disp)
    disp('     #------------------------------------------------------------');
    disp('Projection matrix (in mm): ');
    fprintf('\np11: %f2, p12: %f2, p13: %f2, p14: %f2', p11, p12, p13, p14*0.003);
    fprintf('\np21: %f2, p22: %f2, p23: %f2, p24: %f2', p21, p22, p23, p24*0.003);
    fprintf('\np31: %f2, p32: %f2, p33: %f2, p34: %f2\n', p31, p32, p33, p34*0.003);
    disp('     #------------------------------------------------------------');
...
calib_data.R_rodrigues=rodrigues(calib_data.R);
