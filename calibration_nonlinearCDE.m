...
function calib_data = calibration_nonlinearCDE(calib_data)
...
% %     end
    ...
    [ssout,resnorm,residual,exitflag,output] =lsqnonlin(@refine_intrinsicCDE,f0,-inf*ones(length(f0),1),inf*ones(length(f0),1),options,calib_data.ocam_model.xc,calib_data.ocam_model.yc,ss0,calib_data.RRfin,calib_data.ima_proc,calib_data.Xp_abs,calib_data.Yp_abs,M, calib_data.ocam_model.width, calib_data.ocam_model.height);
