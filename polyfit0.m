...
%   $Revision: 1.1 $  $Date: 2015/03/12 06:36:54EDT $
%   POLYFIT0 CREATED BY AJUTAN MARCH 6-2000

%   Line 61: p = [p;0]; Inserted by Jagmal
...
r = y - V*p;
p = [p;0]; % set y-intercept to zero % Added by Jagmal to have really a0 in the polynomial
