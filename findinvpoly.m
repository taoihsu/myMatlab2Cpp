...
%     maxerr = inf;
%     N = 1;
%     while maxerr > 0.05 %Repeat until the reprojection error is smaller than 0.05 pixels, originally it was 0.01 pixels
%         N = N + 1;
...
% Here it is forced have just the same number of parameters as poly in inverse polynomial
maxerr = inf;
N = length(ss);
[pol, err] = findinvpoly2(ss, radius, N-1);
